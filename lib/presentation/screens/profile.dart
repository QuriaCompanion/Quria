                          ...
                          children: [
                            Padding(
                              ...
                              child: SizedBox(
                                  width: 561,
                                  child:
                                      ProfileTitleWidget(data: snapshot.data)),
                            ),
                            Padding(
...
class DetailsWeaponWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const double linearWidth = 350;
    const double sizedRocketHeight = 9;
    const double linearDividerArmor = 42;
    const double linearDividerWeapon = 100;
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (stats['3614673599']?.value != null)
                                SizedBox(height: sizedRocketHeight),
                            ...
                            children: [
                              ...
                              if (stats['2996146975']?.value != null)
                                LinearPercentIndicator(
                                  percent: (stats['2996146975']!.value!) /
                                      linearDividerArmor,
                              ...
                              if (stats['1943323491']?.value != null)
                                LinearPercentIndicator(
                                  percent: (stats['1943323491']!.value!) /
                                      linearDividerArmor,
                                  progressColor: Colors.white,
                                  lineHeight: 24,
                                  width: linearWidth,
                              ...
                              if (stats['1735777505']?.value != null)
                                LinearPercentIndicator(
                                  percent: (stats['1735777505']!.value!) /
                                      linearDividerArmor,
                                  progressColor: Colors.white,
                                  lineHeight: 24,
                                  width: linearWidth,
                              ...
                              if (stats['4244567218']?.value != null)
                                LinearPercentIndicator(
                                  percent: (stats['4244567218']!.value!) /
                                      linearDividerArmor,
                                  progressColor: Colors.white,
                                  lineHeight: 24,
                                  width: linearWidth,
                              ...
                              if (stats['3614673599']?.value != null)
                                LinearPercentIndicator(
                                  percent: (stats['3614673599']!.value!) /
                                      linearDividerWeapon,
                                  progressColor: Colors.white,
                                  lineHeight: 24,
                                  width: linearWidth,
                              ...
                              if (stats['2523465841']?.value != null)
                                LinearPercentIndicator(
                                  percent: (stats['2523465841']!.value!) /
                                      linearDividerWeapon,
                                  progressColor: Colors.white,
                                  lineHeight: 24,
                                  width: linearWidth,
                              ...
                              if (stats['4043523819']?.value != null)
                                LinearPercentIndicator(
                                  percent: (stats['4043523819']!.value!) /
                                      linearDividerWeapon,
                                  progressColor: Colors.white,
                                  lineHeight: 24,
                                  width: linearWidth,
                              ...
                              if (stats['1240592695']?.value != null)
                                LinearPercentIndicator(
                                  percent: (stats['1240592695']!.value!) /
                                      linearDividerWeapon,
                                  progressColor: Colors.white,
                                  lineHeight: 24,
                                  width: linearWidth,
                              ...
                              if (stats['4188031367']?.value != null)
                                LinearPercentIndicator(
                                  percent: (stats['4188031367']!.value!) /
                                      linearDividerWeapon,
                                  progressColor: Colors.white,
                                  lineHeight: 24,
                                  width: linearWidth,
                              ...
                              if (stats['1345609583']?.value != null)
                                LinearPercentIndicator(
                                  percent: (stats['1345609583']!.value!) /
                                      linearDividerWeapon,
                                  progressColor: Colors.white,
                                  lineHeight: 24,
                                  width: linearWidth,
