...
class DefinitionTableNames {
  static Map<Type, Function> getDefinitions = {
    ...
    DestinyDamageTypeDefinition: (ids) async => await StorageService.isar.destinyDamageTypeDefinitions.getAll(ids),
    DestinyStatDefinition: (ids) async => await StorageService.isar.destinyStatDefinitions.getAll(ids),
    DestinyTalentGridDefinition: (ids) async => await StorageService.isar.destinyTalentGridDefinitions.getAll(ids),
    DestinySandboxPerkDefinition: (ids) async => await StorageService.isar.destinySandboxPerkDefinitions.getAll(ids),
    DestinyEnergyTypeDefinition: (ids) async => await StorageService.isar.destinyEnergyTypeDefinitions.getAll(ids),
    DestinyEquipmentSlotDefinition: (ids) async =>
        await StorageService.isar.destinyEquipmentSlotDefinitions.getAll(ids),
    DestinyPresentationNodeDefinition: (ids) async =>
        await StorageService.isar.destinyPresentationNodeDefinitions.getAll(ids),
    DestinyCollectibleDefinition: (ids) async => await StorageService.isar.destinyCollectibleDefinitions.getAll(ids),
    DestinyPlugSetDefinition: (ids) async => await StorageService.isar.destinyPlugSetDefinitions.getAll(ids),
