...
class DestinyTalentGridDefinition {
  ...
  @JsonKey(name: 'nodes')
  @ClassListNullableConverter<DestinyTalentNodeDefinition>()
  ...
  @ClassListNullableConverter<DestinyTalentNodeExclusiveSetDefinition>()
  ...
  @JsonKey(name: 'groups')
  @MapClassConverter<DestinyTalentExclusiveGroup>()
  ...
  @ClassListNullableConverter<DestinyTalentNodeCategory>()
